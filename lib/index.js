// dsh-qq-notify 宿主插件（安装包版）— 对应单文件镜像 host.js（v19）
...
// ---------- 插件主体 ----------
export default {
  inject: ['connection', 'subprocess', 'fs', 'credentials', 'sessionTitle', 'sandboxPolicy', 'agents'],
  async apply(ctx) {
    ...
    console.log('[qq-notify] 插件已启动（安装包版 v1.0.0）：工作区 =', workspaceRoot || '(无)', '配置 =', await configFilePath() || '(无)')
  },
}
